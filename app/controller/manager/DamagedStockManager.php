...
class DamagedStockManager extends \fw\controller\manager\StdManager
{
    private $trace = false;
    protected $name = "Damaged Stock";
    protected $db;
    ...
    public function getallrecords(&$datafields, $orderby, &$parents, &$numrows, $withlock=false, $trace=false) {
        ...
        $success = $this->table->getmovementsbyeventtype('adjustment', $datafields, $numrows, $trace);
